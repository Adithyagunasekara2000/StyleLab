...
<body class="bg-gray-100 min-h-screen flex flex-col md:flex-row">
    ...
    <aside class="bg-black text-white w-full md:w-64 flex-shrink-0 md:min-h-screen" x-data="{ isOpen: false }">
        ...
        <nav class="mt-6" :class="{'hidden': !isOpen}" class="md:block">
            <a href="dashboard.php" class="flex items-center py-3 px-4 bg-gray-800 text-white hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
                Dashboard
            </a>
            <a href="products.php" class="flex items-center py-3 px-4 text-gray-300 hover:bg-gray-700 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
